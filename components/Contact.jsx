    ...
    <div id="contact" className='flex flex-col w-screen h-screen justify-center'>
      ...
      <div className="self-center grid grid-cols-2 md:grid-cols-4 w-1/3 mt-8 gap-9">
        <div className="flex flex-col justify-center align-middle">
          <Link href={"https://linkedin.com/in/mateopineiro"} target="_blank" rel="noreferrer">
            <Image alt="" src={linkedin} objectFit="contain" width={300} height={300} />
          </Link>
        </div>
        <div className="flex flex-col justify-center align-middle">
          <Link href={"https://github.com/mateopineiroa"} target="_blank" rel="noreferrer">
            <Image alt="" src={github} objectFit="contain" width={300} height={300} />
          </Link>
        </div>
        <div className="flex flex-col justify-center align-middle">
          <Link href={"https://api.whatsapp.com/send?phone=59898557448&text=Estoy%20interesado/a%20en%20hablar"} target="_blank" rel="noreferrer">
            <Image alt="" src={wsp} objectFit="contain" width={300} height={300} />
          </Link>
        </div>
        <div className="flex flex-col justify-center align-middle">
          <Link className="" href={"mailto:john@example.com"} rel="noreferrer">
